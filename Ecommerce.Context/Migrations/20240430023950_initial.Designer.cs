...
namespace Ecommerce.Context.Migrations
{
    ...
    [Migration("20240430023950_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ecommerce.Models.auth.CustomizedUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Ecommerce.Models.Product", b =>
                {
                    b.HasOne("Ecommerce.Models.Category", "CategoryName")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Ecommerce.Models.auth.CustomizedUser", null)
                        .WithMany()
